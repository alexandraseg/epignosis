...
<div class="wrapper bgded overlay gradient" style="background-image:url('../../images/demo/backgrounds/user.jpg');">
  ...
  <h6 class="heading">Εγγραφή Νέου Χρήστη</h6>
    
    <ul>
      <li><a href="../index.php">Αρχική</a></li>
      <li><p class="active-breadcrumb">Εγγραφή Νέου Χρήστη<p></li>
    </ul>
            ...
            <form action="backend/register.php" method = "post">
                <div class="form-row">                  
                  <div class = "form-column">
                    <label id="register-user-type">Eπιλέξτε την κατηγορία που ανήκει: *</label>
